"use strict";
(self["webpackChunkweather_app_api"] = self["webpackChunkweather_app_api"] || []).push([["index"],{
...
var ___CSS_LOADER_URL_IMPORT_1___ = new URL(/* asset import */ __webpack_require__(/*! ./assets/search.png */ "./src/assets/search.png"), __webpack_require__.b);
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
var ___CSS_LOADER_URL_REPLACEMENT_0___ = _node_modules_css_loader_dist_runtime_getUrl_js__WEBPACK_IMPORTED_MODULE_2___default()(___CSS_LOADER_URL_IMPORT_0___);
var ___CSS_LOADER_URL_REPLACEMENT_1___ = _node_modules_css_loader_dist_runtime_getUrl_js__WEBPACK_IMPORTED_MODULE_2___default()(___CSS_LOADER_URL_IMPORT_1___);
// Module
___CSS_LOADER_EXPORT___.push([module.id, ":root {\n    --footer-font: 'Tilt Neon', system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;\n    --head-font: 'Alkatra', system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;\n    --body-font: 'Didact Gothic', system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;\n\n    margin: 0;\n    padding: 0;\n    width: 100%;\n    height: 100%;\n    background-image: linear-gradient(rgba(0, 0, 0, 0.1), rgba(0, 0, 0, 0.1)), url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ");\n    background-repeat: no-repeat;\n    background-size: cover;\n    color: rgb(255, 255, 255);\n    font-family: var(--body-font);\n}\n\n.footer-container {\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    position: fixed;\n    bottom: 0;\n    width: max(200px, 100%);\n    font-size: 1rem;\n    font-family: var(--footer-font)\n}\n\n#date-display {\n    grid-row: 1 / 2;\n    grid-column: 1 / 2;\n    text-align: right;\n}\n\n#time-display {\n    grid-row: 1 / 2;\n    grid-column: 3 / 4;\n    text-align: left;\n}\n\n#github-logo {\n    height: 40px;\n    width: 40px;\n}\n\n#logo {\n    height: 100px;\n}\n\n.icon {\n    height: 64px;\n    width: 64px;\n}\n\n#content-container {\n    display: grid;\n    justify-content: center;\n    align-items: center;\n    flex-direction: column;\n    grid-template-columns: 1fr 1fr 1fr;\n    grid-template-rows: 0.3fr 1fr 1fr\n}\n\n#main-text {\n    font-family: var(--head-font);\n    font-size: 4.5rem;\n    margin: 0;\n    height: 6rem;\n    text-align: center;\n}\n\n#places {\n    border: none;\n    border-bottom: 2px solid rgb(255, 255, 255);\n    outline: none;\n    font-size: 1rem;\n    padding: 5px 5px;\n    width: 300px;\n    background-color: transparent;\n    color: white;\n    font-family: var(--body-font);\n}\n\n#search-container {\n    display: flex;\n    grid-row: 2 / 3;\n    grid-column: 2 / 3;\n    flex-direction: column;\n    align-items: center;\n    justify-content: center;\n}\n\n#search-wrapper {\n    display: flex;\n    justify-items: center;\n    align-items: center;\n}\n\n#places::placeholder {\n    font-size: 0.9rem;\n}\n\n#search-button {\n    background-image: url(" + ___CSS_LOADER_URL_REPLACEMENT_1___ + ");\n    background-size: 2rem;\n    height: 2rem;\n    width: 2rem;\n    border: 0;\n    background-color: transparent;\n    background-repeat: no-repeat;\n    padding: 0;\n}\n\n#result-name {\n    text-align: center;\n}\n\n.current-weather-wrapper-left {\n    grid-row: 2 / 3;\n    grid-column: 1 / 2;\n    padding: 20px;\n}\n\n.current-weather-left-container {\n    display: flex;\n    flex-direction: column;\n    align-items: flex-end;\n}\n\n.current-weather-right-container > h1,\n.current-weather-right-header > h2,\n.current-weather-left-container > h1,\n.current-weather-left-header > h2 {\n    margin: 0;\n}\n\n.current-weather-right-header,\n.current-weather-left-header {\n    display: flex;\n    align-items: center;\n    gap: 5px;\n}\n\n#current-temp-text {\n    font-size: 2rem;\n}\n\n#current-feeltemp-text {\n    text-align: right;\n    font-size: 1rem;\n}\n\n.current-weather-wrapper-right {\n    grid-row: 2 / 3;\n    grid-column: 3 / 4;\n    padding: 20px;\n}\n\n.forecast-weather-wrapper-1 {\n    grid-row: 3 / 4;\n    grid-column: 1 / 2;\n    display: flex;\n    align-items: center;\n    justify-content: space-around\n}\n\n.forecast-weather-wrapper-2 {\n    grid-row: 3 / 4;\n    grid-column: 3 / 4;\n    display: flex;\n    align-items: center;\n    justify-content: space-around\n}\n\n.forecast-weather-container {\n    display: flex;\n    flex-direction: column;\n    align-items: center;\n    justify-content: center;\n    text-align: center;\n}\n\n.forecast-time,\n.forecast-weather-container > p {\n    margin: 5px;\n}\n\n.forecast-header {\n    display: flex;\n    flex-direction: column;\n    align-items: center;\n    justify-content: center;\n    font-weight: 700;\n}", "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;IACI,kKAAkK;IAClK,8JAA8J;IAC9J,oKAAoK;;IAEpK,SAAS;IACT,UAAU;IACV,WAAW;IACX,YAAY;IACZ,kHAAuG;IACvG,4BAA4B;IAC5B,sBAAsB;IACtB,yBAAyB;IACzB,6BAA6B;AACjC;;AAEA;IACI,aAAa;IACb,uBAAuB;IACvB,mBAAmB;IACnB,eAAe;IACf,SAAS;IACT,uBAAuB;IACvB,eAAe;IACf;AACJ;;AAEA;IACI,eAAe;IACf,kBAAkB;IAClB,iBAAiB;AACrB;;AAEA;IACI,eAAe;IACf,kBAAkB;IAClB,gBAAgB;AACpB;;AAEA;IACI,YAAY;IACZ,WAAW;AACf;;AAEA;IACI,aAAa;AACjB;;AAEA;IACI,YAAY;IACZ,WAAW;AACf;;AAEA;IACI,aAAa;IACb,uBAAuB;IACvB,mBAAmB;IACnB,sBAAsB;IACtB,kCAAkC;IAClC;AACJ;;AAEA;IACI,6BAA6B;IAC7B,iBAAiB;IACjB,SAAS;IACT,YAAY;IACZ,kBAAkB;AACtB;;AAEA;IACI,YAAY;IACZ,2CAA2C;IAC3C,aAAa;IACb,eAAe;IACf,gBAAgB;IAChB,YAAY;IACZ,6BAA6B;IAC7B,YAAY;IACZ,6BAA6B;AACjC;;AAEA;IACI,aAAa;IACb,eAAe;IACf,kBAAkB;IAClB,sBAAsB;IACtB,mBAAmB;IACnB,uBAAuB;AAC3B;;AAEA;IACI,aAAa;IACb,qBAAqB;IACrB,mBAAmB;AACvB;;AAEA;IACI,iBAAiB;AACrB;;AAEA;IACI,yDAA4C;IAC5C,qBAAqB;IACrB,YAAY;IACZ,WAAW;IACX,SAAS;IACT,6BAA6B;IAC7B,4BAA4B;IAC5B,UAAU;AACd;;AAEA;IACI,kBAAkB;AACtB;;AAEA;IACI,eAAe;IACf,kBAAkB;IAClB,aAAa;AACjB;;AAEA;IACI,aAAa;IACb,sBAAsB;IACtB,qBAAqB;AACzB;;AAEA;;;;IAII,SAAS;AACb;;AAEA;;IAEI,aAAa;IACb,mBAAmB;IACnB,QAAQ;AACZ;;AAEA;IACI,eAAe;AACnB;;AAEA;IACI,iBAAiB;IACjB,eAAe;AACnB;;AAEA;IACI,eAAe;IACf,kBAAkB;IAClB,aAAa;AACjB;;AAEA;IACI,eAAe;IACf,kBAAkB;IAClB,aAAa;IACb,mBAAmB;IACnB;AACJ;;AAEA;IACI,eAAe;IACf,kBAAkB;IAClB,aAAa;IACb,mBAAmB;IACnB;AACJ;;AAEA;IACI,aAAa;IACb,sBAAsB;IACtB,mBAAmB;IACnB,uBAAuB;IACvB,kBAAkB;AACtB;;AAEA;;IAEI,WAAW;AACf;;AAEA;IACI,aAAa;IACb,sBAAsB;IACtB,mBAAmB;IACnB,uBAAuB;IACvB,gBAAgB;AACpB","sourcesContent":[":root {\n    --footer-font: 'Tilt Neon', system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;\n    --head-font: 'Alkatra', system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;\n    --body-font: 'Didact Gothic', system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;\n\n    margin: 0;\n    padding: 0;\n    width: 100%;\n    height: 100%;\n    background-image: linear-gradient(rgba(0, 0, 0, 0.1), rgba(0, 0, 0, 0.1)), url(./assets/background.jpg);\n    background-repeat: no-repeat;\n    background-size: cover;\n    color: rgb(255, 255, 255);\n    font-family: var(--body-font);\n}\n\n.footer-container {\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    position: fixed;\n    bottom: 0;\n    width: max(200px, 100%);\n    font-size: 1rem;\n    font-family: var(--footer-font)\n}\n\n#date-display {\n    grid-row: 1 / 2;\n    grid-column: 1 / 2;\n    text-align: right;\n}\n\n#time-display {\n    grid-row: 1 / 2;\n    grid-column: 3 / 4;\n    text-align: left;\n}\n\n#github-logo {\n    height: 40px;\n    width: 40px;\n}\n\n#logo {\n    height: 100px;\n}\n\n.icon {\n    height: 64px;\n    width: 64px;\n}\n\n#content-container {\n    display: grid;\n    justify-content: center;\n    align-items: center;\n    flex-direction: column;\n    grid-template-columns: 1fr 1fr 1fr;\n    grid-template-rows: 0.3fr 1fr 1fr\n}\n\n#main-text {\n    font-family: var(--head-font);\n    font-size: 4.5rem;\n    margin: 0;\n    height: 6rem;\n    text-align: center;\n}\n\n#places {\n    border: none;\n    border-bottom: 2px solid rgb(255, 255, 255);\n    outline: none;\n    font-size: 1rem;\n    padding: 5px 5px;\n    width: 300px;\n    background-color: transparent;\n    color: white;\n    font-family: var(--body-font);\n}\n\n#search-container {\n    display: flex;\n    grid-row: 2 / 3;\n    grid-column: 2 / 3;\n    flex-direction: column;\n    align-items: center;\n    justify-content: center;\n}\n\n#search-wrapper {\n    display: flex;\n    justify-items: center;\n    align-items: center;\n}\n\n#places::placeholder {\n    font-size: 0.9rem;\n}\n\n#search-button {\n    background-image: url('./assets/search.png');\n    background-size: 2rem;\n    height: 2rem;\n    width: 2rem;\n    border: 0;\n    background-color: transparent;\n    background-repeat: no-repeat;\n    padding: 0;\n}\n\n#result-name {\n    text-align: center;\n}\n\n.current-weather-wrapper-left {\n    grid-row: 2 / 3;\n    grid-column: 1 / 2;\n    padding: 20px;\n}\n\n.current-weather-left-container {\n    display: flex;\n    flex-direction: column;\n    align-items: flex-end;\n}\n\n.current-weather-right-container > h1,\n.current-weather-right-header > h2,\n.current-weather-left-container > h1,\n.current-weather-left-header > h2 {\n    margin: 0;\n}\n\n.current-weather-right-header,\n.current-weather-left-header {\n    display: flex;\n    align-items: center;\n    gap: 5px;\n}\n\n#current-temp-text {\n    font-size: 2rem;\n}\n\n#current-feeltemp-text {\n    text-align: right;\n    font-size: 1rem;\n}\n\n.current-weather-wrapper-right {\n    grid-row: 2 / 3;\n    grid-column: 3 / 4;\n    padding: 20px;\n}\n\n.forecast-weather-wrapper-1 {\n    grid-row: 3 / 4;\n    grid-column: 1 / 2;\n    display: flex;\n    align-items: center;\n    justify-content: space-around\n}\n\n.forecast-weather-wrapper-2 {\n    grid-row: 3 / 4;\n    grid-column: 3 / 4;\n    display: flex;\n    align-items: center;\n    justify-content: space-around\n}\n\n.forecast-weather-container {\n    display: flex;\n    flex-direction: column;\n    align-items: center;\n    justify-content: center;\n    text-align: center;\n}\n\n.forecast-time,\n.forecast-weather-container > p {\n    margin: 5px;\n}\n\n.forecast-header {\n    display: flex;\n    flex-direction: column;\n    align-items: center;\n    justify-content: center;\n    font-weight: 700;\n}"],"sourceRoot":""}]);
// Exports
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _weather_module_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./weather_module.js */ "./src/weather_module.js");
/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style.css */ "./src/style.css");
/* harmony import */ var _dom_interface__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./dom_interface */ "./src/dom_interface.js");
/* harmony import */ var _assets_githublogo_png__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./assets/githublogo.png */ "./src/assets/githublogo.png");
/* harmony import */ var _assets_cloud_png__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./assets/cloud.png */ "./src/assets/cloud.png");
/* harmony import */ var _assets_precipitation_png__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./assets/precipitation.png */ "./src/assets/precipitation.png");
...
const APIModule = (() => {
  ...
  async function showResults (input) {
    const results = await _weather_module_js__WEBPACK_IMPORTED_MODULE_0__["default"].search(input)
  ...
  async function getForecast () {
    ...
    const results = await _weather_module_js__WEBPACK_IMPORTED_MODULE_0__["default"].retrieveForecast(input)

    return results
  }

  async function getCurrent (input) {
    const results = await _weather_module_js__WEBPACK_IMPORTED_MODULE_0__["default"].retrieveCurrent(input)
    return results
  }
...
_dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].insertToById('search-container', _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].createElement('img', '', 'logo'))
document.querySelector('#logo').src = _assets_cloud_png__WEBPACK_IMPORTED_MODULE_4__
...
_dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].insertToById('search-container', _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].createElement('h2', '', 'result-name'))

// create footer
document.body.appendChild(_dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].createElement('div', 'footer-container', ''))
const footerText = '© ' + new Date().getFullYear() + ' coffeedevr | '
_dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].insertToByClass('footer-container', _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].createElement('p', '', 'footer-text'))
_dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].insertTextContentById('footer-text', footerText)
_dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].insertToByClass('footer-container', _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].createImgById('github-logo', _assets_githublogo_png__WEBPACK_IMPORTED_MODULE_3__))
...
async function displayResults () {
  ...
  _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].insertTextContentById('result-name', current.location.name + ', ' + current.location.region + '<br>' + current.location.country)
  document.querySelector('#weather-logo').src = current.current.condition.icon

  // left container
  _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].insertTextContentById('current-condition-name', current.current.condition.text)
  _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].insertTextContentById('current-temp-text', current.current.temp_c + '° C | ' + current.current.temp_f + '° F')
  _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].insertTextContentById('current-feeltemp-text', 'Feels like: <br>' + current.current.feelslike_c + '° C | ' + current.current.feelslike_f + '° F')

  // right container
  _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].insertTextContentById('current-preci-name', current.current.precip_mm + ' mm | ' + current.current.precip_in + ' in')
  _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].insertTextContentById('current-humi-text', current.current.humidity + '% Humidity')
  _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].insertTextContentById('current-wind-text', 'Wind: ' + current.current.wind_degree + '° ' + current.current.wind_dir + '<br>' + current.current.wind_kph + ' kph | ' + current.current.wind_mph + ' mph')

  // forecast
  for (let i = 9; i <= 18; i += 3) {
    _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].insertTextContentById('forecast-time-' + i, i + ':00')
    document.querySelector('#forecast-weather-logo-' + i).src = forecast.forecast.forecastday[0].hour[i].condition.icon
    _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].insertTextContentById('forecast-temp-' + i, forecast.forecast.forecastday[0].hour[i].temp_c + '° C | ' + forecast.forecast.forecastday[0].hour[i].temp_f + '° F')
    _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].insertTextContentById('forecast-preci-' + i, forecast.forecast.forecastday[0].hour[i].precip_mm + ' mm | ' + forecast.forecast.forecastday[0].hour[i].precip_in + ' in')
    _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].insertTextContentById('forecast-humi-' + i, forecast.forecast.forecastday[0].hour[i].humidity + '% Humidity')
    _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].insertTextContentById('forecast-wind-' + i, 'Wind: ' + forecast.forecast.forecastday[0].hour[i].wind_degree + '° ' + forecast.forecast.forecastday[0].hour[i].wind_dir + '<br>' + forecast.forecast.forecastday[0].hour[i].wind_kph + ' kph | ' + forecast.forecast.forecastday[0].hour[i].wind_mph + ' mph')
  }
}

function buildDOM () {
  _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].insertToById('content-container', _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].createElement('p', '', 'date-display'))
  _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].insertToById('content-container', _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].createElement('p', '', 'time-display'))
  ...
  _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].insertToById('content-container', _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].createElement('div', 'current-weather-wrapper-left', ''))
  _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].insertToById('content-container', _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].createElement('div', 'current-weather-wrapper-right', ''))
  _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].insertToById('content-container', _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].createElement('div', 'forecast-weather-wrapper-1', ''))
  _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].insertToById('content-container', _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].createElement('div', 'forecast-weather-wrapper-2', ''))

  // left container
  _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].insertToByClass('current-weather-wrapper-left', _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].createElement('div', 'current-weather-left-container', ''))
  _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].insertToByClass('current-weather-left-container', _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].createElement('div', 'current-weather-left-header', ''))

  _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].insertToByClass('current-weather-left-header', _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].createElement('img', 'icon', 'weather-logo'))
  _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].insertToByClass('current-weather-left-header', _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].createElement('h2', '', 'current-condition-name'))

  _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].insertToByClass('current-weather-left-container', _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].createElement('h1', '', 'current-temp-text'))
  _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].insertToByClass('current-weather-left-container', _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].createElement('p', '', 'current-feeltemp-text'))

  // right container
  _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].insertToByClass('current-weather-wrapper-right', _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].createElement('div', 'current-weather-right-container', ''))
  _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].insertToByClass('current-weather-right-container', _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].createElement('div', 'current-weather-right-header', ''))

  _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].insertToByClass('current-weather-right-header', _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].createElement('h2', '', 'current-preci-name'))
  _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].insertToByClass('current-weather-right-header', _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].createElement('img', 'icon', 'preci-logo'))
  document.querySelector('#preci-logo').src = _assets_precipitation_png__WEBPACK_IMPORTED_MODULE_5__

  _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].insertToByClass('current-weather-right-container', _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].createElement('h1', '', 'current-humi-text'))
  _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].insertToByClass('current-weather-right-container', _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].createElement('p', '', 'current-wind-text'))

  // forecast
  for (let i = 9; i <= 18; i += 3) {
    const a = () => i >= 15 ? 2 : 1
    _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].insertToByClass('forecast-weather-wrapper-' + a(), _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].createElement('div', 'forecast-weather-container', 'forecast-weather-container-' + i))
    _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].insertToById('forecast-weather-container-' + i, _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].createElement('div', 'forecast-header', 'forecast-weather-header-' + i))
    _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].insertToById('forecast-weather-header-' + i, _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].createElement('img', 'icon', 'forecast-weather-logo-' + i))
    _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].insertToById('forecast-weather-header-' + i, _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].createElement('p', 'forecast-time', 'forecast-time-' + i))
    _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].insertToById('forecast-weather-container-' + i, _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].createElement('p', '', 'forecast-temp-' + i))
    _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].insertToById('forecast-weather-container-' + i, _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].createElement('img', 'icon', 'forecast-preci-logo-' + i))
    _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].insertToById('forecast-weather-container-' + i, _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].createElement('p', '', 'forecast-preci-' + i))
    document.querySelector('#forecast-preci-logo-' + i).src = _assets_precipitation_png__WEBPACK_IMPORTED_MODULE_5__
    _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].insertToById('forecast-weather-container-' + i, _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].createElement('p', '', 'forecast-humi-' + i))
    _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].insertToById('forecast-weather-container-' + i, _dom_interface__WEBPACK_IMPORTED_MODULE_2__["default"].createElement('p', '', 'forecast-wind-' + i))
  }
}

async function updateTime () {
  const current = await APIModule.getCurrent(location)
  const date = (0,date_fns_tz__WEBPACK_IMPORTED_MODULE_6__.formatInTimeZone)(new Date(), current.location.tz_id, 'EEEE MMMM d, yyyy')
  const time = (0,date_fns_tz__WEBPACK_IMPORTED_MODULE_6__.formatInTimeZone)(new Date(), current.location.tz_id, 'HH:mm:ss zzz')
...
module.exports = __webpack_require__.p + "assets/97c3bdd27e58b7593f60.jpg";
...
module.exports = __webpack_require__.p + "assets/016c9e63d866bd9a0fd1.png";
...
module.exports = __webpack_require__.p + "assets/f3edd70b1871c532d406.png";
...
module.exports = __webpack_require__.p + "assets/ac065c808b5a0bebac63.png";
...
module.exports = __webpack_require__.p + "assets/824388f1722b562e8d0e.png";
